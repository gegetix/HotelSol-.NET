...
class exportarHabitacion(cec.conexionSQL):

    def __init__(self,*args,**kwargs):
        super().__init__(*args,**kwargs)
        self.exportarHabitacion()
    # Conexión a PostgreSQL
    def exportarHabitacion(self):
        ...
        sql_query = "SELECT * FROM habitacion"
        ...
        tree.write("habitacionExportar.xml")
